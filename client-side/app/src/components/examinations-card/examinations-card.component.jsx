...
const examinationCard = ({ handleDelete, handleStatus, id, doctor, medical_examination, completed, description }) => (
    <div className="examinations-container">
        <div className="examinations-cart">
            ...
            <div className="buttons">
                {completed ? <CustomButton onClick={() => { handleStatus(id) }} style={{ background: '#E65100' }}> Ακυρωση </CustomButton>
                    : <CustomButton onClick={() => { handleStatus(id) }} style={{ background: '#1B5E20' }} > &#10004; </CustomButton>}
                <CustomButton style={{ background: '#FFAB00' }}> &#9997; </CustomButton>
                <CustomButton onClick={() => { handleDelete(id) }} style={{ background: '#B71C1C' }}> &#10008;  </CustomButton>
            </div>
        </div>
    </div >
)
